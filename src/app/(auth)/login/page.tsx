        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl dark:shadow-2xl p-8">
          ...
          <div className="flex justify-center mb-8">
            <div className="flex items-center space-x-2">
                <Image  src="/images/SmileTrace.png" alt="Logo" className="w-20 h-20 text-blue-600 dark:text-blue-400" width={80} height={80} />
                <span className="text-2xl font-bold text-gray-900 dark:text-white">SmileTrace</span>
            </div>
          </div>
                   
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Bine ai venit!</h1>
            <p className="text-gray-600 dark:text-gray-400 mt-2">Conectează-te la contul tău</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                ...
                <span className="ml-2 text-sm text-gray-600 dark:text-gray-400">Ține-mă minte</span>
              </label>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 transition duration-200 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400">Sau continuă cu</span>
              </div>
            </div>
